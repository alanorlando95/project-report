...
%-------------------------------------------------------------------------------
    ...
    %-------------------------------------------------------------------------------
        ...
        \label{sub:Projection of the point cloud onto the xy-plane}
            ...
            \begin{figure}\centering
                \begin{tikzpicture}[zoomboxarray, zoomboxarray columns=1, zoomboxarray rows=1, figurename = source_image]
            ...
            \begin{figure}\centering
                \begin{tikzpicture}[zoomboxarray, zoomboxarray columns=1, zoomboxarray rows=1, figurename = target_image]
                    \node [image node] { \includegraphics[scale=0.12]{images/solution_images/target_image_inverted.png} };
                    \zoombox[magnification=3, color code=red]{0.4,0.57}
                \end{tikzpicture}
                \caption{Projection of the target onto the xy-palne.}
                \label{fig:target_image}
            \end{figure}
    ...
    %-------------------------------------------------------------------------------
        \subsection{Detection of line segments}
            ...
            \begin{figure}\centering
                \begin{tikzpicture}[zoomboxarray, zoomboxarray columns=1, zoomboxarray rows=1, figurename = source_image_filter]
    ...
    %-------------------------------------------------------------------------------
        \subsection{Detection of line intersections and their angles}
            ...
            \begin{figure}\centering
                \begin{tikzpicture}[zoomboxarray, zoomboxarray columns=1, zoomboxarray rows=1, figurename = source_intersections]
            ...
            \begin{figure}\centering
                \begin{tikzpicture}[zoomboxarray, zoomboxarray columns=1, zoomboxarray rows=1, figurename = target_intersections]
    ...
    %-------------------------------------------------------------------------------
        \subsection{Alignment of both projections onto the xy-plane}
            ...
            \begin{figure}\centering
                \begin{tikzpicture}[zoomboxarray, zoomboxarray columns=1, zoomboxarray rows=1, figurename = 2D_initial]
                    \node [image node] { \includegraphics[scale=0.1]{images/solution_images/2D_XY_initial_inverted.png} };
                    \zoombox[magnification=3, color code=lime]{0.4,0.57}
                \end{tikzpicture}
                \caption{Initial position of the source image and the target image.}
                \label{fig:2D_initial}
            \end{figure}
            ...
            \begin{figure}\centering
                \begin{tikzpicture}[zoomboxarray, zoomboxarray columns=1, zoomboxarray rows=1, figurename = 2D_aligned]
