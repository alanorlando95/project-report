    ...
    \centering
        \begin{tikzpicture}[->, >=latex]
            ...
            & &
              ...
              \node (ptpg) [fill=cyan, anchor=base west, align=center] {global\\ \cite{Pankaj_2015_arobust, Quan_2020_com, Sakakubara_2007_automatic, Wang_2019_deepclosest, Sarode_2019_oneframework, Huang_2020_feature} }; & &
...
%-------------------------------------------------------------------------------
    ...
    ICP and its variants provide simple and easily-implemented iterative methods, but these algorithms can converge to false local optima cc.
