...
\begin{document}
    ...
    \section{Point-to-point registration}
        ...
        of the RANSAC algorithm. Therefore, S. Quan and J. Yang \cite{Quan_2020_com} propose a method that helps the RANSAC algorithm 
        ...
        the best one (the one with the maximum number of inliers) is the final result. 
