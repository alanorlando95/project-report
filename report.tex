...
% ****************************************************
\author{Alan Orlando Gomez Torres}
\title{Registering and visualizing point cloud data with existing 3D CityGML Models}
...
\thirdpartylogo{images/Fraunhofer_IAIS.jpg}
